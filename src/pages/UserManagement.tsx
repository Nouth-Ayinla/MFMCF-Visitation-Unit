...
const UserManagement = () => {
  ...
  const loadData = async () => {
    ...
    const approvedProfiles: Profile[] = profiles.filter(
      (p) => p.is_approved !== false
    );

    // Count pending users
    const pendingProfiles: Profile[] = profiles.filter(
      (p) => p.is_approved === false
    );
    ...
    if (levelData) setLevels(levelData as Level[]);
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Manage user roles, assignments, and activity
            </p>
          </div>
        </div>
        ...
        <TabsContent value="users" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage user roles and assign level coordinators to specific
                        ...
                        <TableRow key={user.id}>
                          ...
                          <TableCell>
                            ...
                            >
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="visitation_coordinator">
                          ...
                          <TableCell>
                            {userRole?.role === "level_coordinator" ? (
                              <Select
                                value={
                                  userRole.assigned_department_id || "none"
                                }
                                onValueChange={(value) =>
                                  updateAssignment(
                                    user.id,
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      This will remove the role assignment for{" "}
                                      {user.email}. The user will remain in the
                                      system but will have no assigned role.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                                    <AlertDialogCancel>
